...
weird_duck = rg.SimpleTurtle('turtle')
weird_duck.pen = rg.Pen('blue',5)
weird_duck.left(90)
weird_duck.forward(200)
weird_duck.pen_up()
weird_duck.go_to(rg.Point(100,-40))
weird_duck.pen_down()
weird_duck.pen = rg.Pen('green',5)
weird_duck.backward(150)
